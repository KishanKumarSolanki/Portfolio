      ...
      <div className="container mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-6">
          {[
            {
              icon: <FaGithub />,
              link: "https://github.com/KishanKumarSolanki",
              
            },
            {
              icon: <FaLinkedin />,
              link: "https://www.linkedin.com/in/Kishan-Solanki-553b441a4",
              
            },
            {
              icon: <FaMailBulk />,
              link: "mailto:kkishankumar9983@gmail.com",
            ...
            <a
              ...
              // title={item.label}
              className="group relative text-xl hover:text-purple-500 transition-transform transform hover:scale-110"
            >
              {item.icon}
            </a>
          ))}
